...
CPG_Result_cpp_t solve_cpp(struct CPG_Updated_cpp_t& CPG_Updated_cpp, struct CPG_Params_cpp_t& CPG_Params_cpp){
    ...
    if (CPG_Updated_cpp.L_ref) {
        for(i=0; i<14; i++) {
            cpg_update_L_ref(i, CPG_Params_cpp.L_ref[i]);
        }
    }
    ...
    if (CPG_Updated_cpp.Z_c) {
        cpg_update_Z_c(CPG_Params_cpp.Z_c);
    }
    if (CPG_Updated_cpp.J_ini) {
        for(i=0; i<9; i++) {
            cpg_update_J_ini(i, CPG_Params_cpp.J_ini[i]);
        }
    }
